...
import tpu
import device_assignment as tpu_device_assignment
import tpu_feed
import tpu_function
import rewriter_config_pb2
import nest as data_nest
import graph_io
...
class TrainLowLevelRunner(object):
  ...
  def __init__(self,
    ...
    self.init_sess = tf.Session(
        self.tpu_cluster_resolver.get_master(), config=self.session_config)
